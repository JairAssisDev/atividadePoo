...
public class AppByteBanck {
    ...
    public static void main(String[] args) {
        ...
        Endereco endereco3 = new Endereco("677878", "recife", "avenida", 687);
        Cliente c3 = new Cliente("paulo", "987654321", "engenheira", endereco3);
        Conta conta3 = new Conta(13233.2, 92323, 23254, c3);
